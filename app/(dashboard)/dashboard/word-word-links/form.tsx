...
import { Form, FormItem, FormLabel, FormMessage } from '@/components/ui/form-2'
...
import { CreateAttrType, AttrType } from './type'
import { onSubmitInvalid } from '@/lib/utils/on-submit-invalid'
import { createAttrSchema } from './schema'
import { cn } from '@/lib/utils'
import { WordsInput } from '../words/_components/input'

export function WordsWordsLinksForm({
  isCreated,
  id,
  defaultValues,
  onSubmitSuccess,
  ...
  const createData = useMutation({
    mutationFn: (data: any) =>
      apiWithToken.post<ResFindOne<AttrType>>(API_INPUTS.wordsWordsLinks, data),
  })
